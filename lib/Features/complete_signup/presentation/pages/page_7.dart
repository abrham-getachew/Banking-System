import 'package:chronos/Features/complete_signup/presentation/pages/page_8.dart';
import 'package:chronos/Features/complete_signup/presentation/pages/repayment.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart'; // For haptic feedback

class TickPayScreen extends StatefulWidget {
  @override
  _TickPayScreenState createState() => _TickPayScreenState();
}

class _TickPayScreenState extends State<TickPayScreen> with TickerProviderStateMixin {
  ...
  bool _shopButtonPressed = false;
  bool _payButtonPressed = false;
  bool _purchasesPressed = false;
  bool _repaymentsPressed = false;
  bool _rewardsPressed = false;
  ...
  void _handleButtonPress(String buttonType, VoidCallback navigation) {
    bool Function() getPressedGetter() {
      switch (buttonType) {
        case 'shop':
          return () => _shopButtonPressed;
        case 'pay':
          return () => _payButtonPressed;
        case 'purchases':
          return () => _purchasesPressed;
        case 'repayments':
          return () => _repaymentsPressed;
        case 'rewards':
          return () => _rewardsPressed;
        default:
          return () => false;
      }
    }
    ...
    VoidCallback setter() {
      return () {
        ...
        switch (buttonType) {
          case 'shop':
            _shopButtonPressed = !isPressed;
            break;
          case 'pay':
            _payButtonPressed = !isPressed;
            break;
          case 'purchases':
            _purchasesPressed = !isPressed;
            break;
          case 'repayments':
            _repaymentsPressed = !isPressed;
            break;
          case 'rewards':
            _rewardsPressed = !isPressed;
            break;
          default:
  ...
  Widget build(BuildContext context) {
    ...
    final primaryColor = Colors.teal[800] ?? Colors.teal;
    final accentColor = Colors.green[900] ?? Colors.green; // Dark green base
    ...
    final double buttonWidth = size.width > 600 ? size.width * 0.40 : size.width * 0.41;
    final double fontScale = scaleFactor;
    final double paddingScale = size.width < 360 ? 0.8 : 1.0;

    final cardGradient = LinearGradient(
      colors: [accentColor, Colors.green[400]!], // Dark green gradient
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                                  ...
                                  AnimatedBuilder(
                                    ...
                                    builder: (context, child) {
                                      return Opacity(
                                        ...
                                        child: Icon(Icons.credit_card, color: Colors.white, size: 24 * fontScale),
                                      );
                                    },
                                  ),
                                ],
                              ...
                              Text(
                                'Spend responsibly and build your credit',
                                style: TextStyle(
                  ...
                  Column(
                    children: [
                      Row(
                        ...
                        children: [
                          _buildAnimatedActionCard(
                            ...
                            color: primaryColor,
                            onPressed: () {
                              _handleButtonPress('shop', () {
                                Navigator.push(
                                  context,
                                  PageRouteBuilder(
                                    pageBuilder: (context, animation, secondaryAnimation) => ShopPage(),
                                    transitionsBuilder: (context, animation, secondaryAnimation, child) {
                                      var curve = CurvedAnimation(parent: animation, curve: Curves.easeInOutCubic);
                                      return SlideTransition(
                                        position: Tween<Offset>(begin: Offset(1.0, 0.0), end: Offset.zero).animate(curve),
                            ...
                            isFilled: true,
                            width: buttonWidth,
                            isPressed: _shopButtonPressed,
                            continuousAnimation: _bounceAnimation,
                      ...
                      Row(
                        ...
                        children: [
                          _buildAnimatedActionCard(
                            ...
                            color: primaryColor,
                            onPressed: () {
                              _handleButtonPress('purchases', () {});
                            },
                            isFilled: false,
                            width: buttonWidth,
                            isPressed: _purchasesPressed,
                          ...
                          _buildAnimatedActionCard(
                            ...
                            color: primaryColor,
                            onPressed: () {
                              _handleButtonPress('repayments', () {
                                Navigator.push(
                                  context,
                                  PageRouteBuilder(
                                    pageBuilder: (context, animation, secondaryAnimation) => RepaymentPage(),
                                    transitionsBuilder: (context, animation, secondaryAnimation, child) {
                                      var curve = CurvedAnimation(parent: animation, curve: Curves.easeInOutCubic);
                                      return SlideTransition(
                                        position: Tween<Offset>(begin: Offset(1.0, 0.0), end: Offset.zero).animate(curve),
                      ...
                      _buildAnimatedActionButton(
                        ...
                        color: primaryColor,
                        onPressed: () {
                          _handleButtonPress('rewards', () {});
                        },
                        isFilled: true,
                        width: double.infinity,
                        isPressed: _rewardsPressed,
  ...
  Widget _buildAnimatedActionCard({
    ...
    final double cardHeight = width * 0.6; // Proportional height (60% of width)
    final cardGradient = LinearGradient(
                  ...
                  continuousAnimation != null
                    ...
                    builder: (context, child) {
                      return Transform.scale(
                        ...
                        child: Icon(icon, color: isFilled ? Colors.white : color, size: 20 * scaleFactor),
                      );
                    },
                  )
                      : Icon(icon, color: isFilled ? Colors.white : color, size: 20 * scaleFactor),
...
class TickPaySettingsScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final primaryColor = Colors.teal[800] ?? Colors.teal;
    final backgroundColor = Colors.grey[50] ?? Colors.white;
    final textColor = Colors.grey[900];
    final size = MediaQuery.of(context).size;
    final fontScale = size.width > 600 ? 1.2 : 1.0;
    ...
    return Scaffold(
          ...
          children: [
            ...
            Container(
              ...
              child: ListTile(
                ...
                title: Text('Credit Card', style: TextStyle(color: textColor)),
                subtitle: Text('Visa ....4567', style: TextStyle(color: Colors.grey[600])),
            ...
            Container(
              ...
              child: ListTile(
                contentPadding: EdgeInsets.symmetric(horizontal: 16),
                title: Text('Paypal', style: TextStyle(color: textColor)),
                trailing: Icon(Icons.chevron_right, color: textColor),
                onTap: () {},
              ),
            ),
            ...
            Container(
              ...
              child: ListTile(
                contentPadding: EdgeInsets.symmetric(horizontal: 16),
                title: Text('View Credit Limit & Eligibility', style: TextStyle(color: primaryColor)),
            ...
            Container(
              ...
              child: ListTile(
                contentPadding: EdgeInsets.symmetric(horizontal: 16),
                title: Text('Notification Settings', style: TextStyle(color: primaryColor)),
                trailing: Icon(Icons.chevron_right, color: primaryColor),
                onTap: () {},
              ),
            ),
            ...
            Container(
              ...
              child: ListTile(
                contentPadding: EdgeInsets.symmetric(horizontal: 16),
                title: Text('Live Chat', style: TextStyle(color: primaryColor)),
                trailing: Icon(Icons.chevron_right, color: primaryColor),
                onTap: () {},
              ),
            ),
            ...
            Container(
              ...
              child: ListTile(
                contentPadding: EdgeInsets.symmetric(horizontal: 16),
                title: Text('FAQ', style: TextStyle(color: primaryColor)),
                trailing: Icon(Icons.chevron_right, color: primaryColor),
                onTap: () {},
              ),
            ),
            ...
            ElevatedButton(
              ...
              child: Text('Return to TickPay Home'),
            ),
            SizedBox(height: 16),
          ],
        ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.hub_outlined), label: 'BlockHub'),
          BottomNavigationBarItem(icon: Icon(Icons.favorite_border), label: 'LifeX'),
          BottomNavigationBarItem(icon: Icon(Icons.format_list_bulleted_rounded), label: 'More'),
        ],
        onTap: (index) {
          // Handle navigation with animation if needed
        },
      ),
    );
  }
